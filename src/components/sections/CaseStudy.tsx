      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-3 gap-6 py-4 border-t border-b border-dx-steel-100">
              {[
                ...
                <div key={stat.label} className="flex flex-col gap-1">
                  ...
                  <span className="dx-caption text-dx-steel-500">{stat.label}</span>
                </div>
              ))}
            </div>

            <blockquote className="flex flex-col gap-2 pl-4 border-l-2 border-dx-blue-500">
              <p className="dx-body text-dx-navy-700 italic">
              ...
              <cite className="dx-caption text-dx-steel-500 not-italic">
